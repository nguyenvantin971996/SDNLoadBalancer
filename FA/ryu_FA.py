    ...
    def install_paths(self, src, first_port, dst, last_port, ip_src, ip_dst):
        if(len(self.paths)==0):
            ...
            if(dst<src):
                src_0 = dst
                dst_0 = src
            # alg_00 = FA(self.adjacency,self.switches,src_0,dst_0,N[0],Max,K_paths,y, a0, b0)
            # alg_00.Do()
            # alg_01 = FA(self.adjacency,self.switches,src_0,dst_0,N[1],Max,K_paths,y, a0, b0)
            # alg_01.Do()
            alg_11 = FA(self.adjacency,self.switches,src_0,dst_0,N[2],Max,K_paths,y, a0, b0)
            alg_11.Do()
