...
class GA:
    ...
    def __init__(self, src, dst, N, Max, K_paths, Pc, Pm, Ts, st):
        self.switches = [i for i in range(1,11)]
        self.src= src
        self.dst = dst
...
Ts = 3
st = "GA_Pm_10"
pr = [str(i) for i in Pm]
pr.reverse()
pr.append("Pm")
alg = GA(1, 4, N, Max, K_paths, Pc, Pm[0], Ts, st)
alg.Do()
alg1 = GA(1, 4, N, Max, K_paths, Pc, Pm[1], Ts, st)
alg1.Do()
alg2 = GA(1, 4, N, Max, K_paths, Pc, Pm[2], Ts, st)
alg2.Do()
