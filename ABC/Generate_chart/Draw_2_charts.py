...
class BarChart:
    ...
    def Do(self):
        ...
        ax.text2D(0.5, 0.85, "Max = 100 (CD = "+str(sum(self.values_1))+")", transform=ax.transAxes)
        ...
        ax1.text2D(0.5, 0.85, "Max = 1000 (CD = "+str(sum(self.values_2))+")", transform=ax1.transAxes)
