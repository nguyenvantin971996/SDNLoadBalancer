    ...
    def install_paths(self, src, first_port, dst, last_port, ip_src, ip_dst):
        if(len(self.paths)==0):
            ...
            if(dst<src):
                ...
                dst_0 = src
            st = "al_ABC"
            # alg_00 = ABC(self.adjacency,self.switches,src_0,dst_0,N[0],Max[0],K_paths,st)
            # alg_00.Do()
            # alg_01 = ABC(self.adjacency,self.switches,src_0,dst_0,N[0],Max[1],K_paths,st)
            # alg_01.Do()
            # alg_10 = ABC(self.adjacency,self.switches,src_0,dst_0,N[1],Max[0],K_paths,st)
            # alg_10.Do()
            # alg_11 = ABC(self.adjacency,self.switches,src_0,dst_0,N[1],Max[1],K_paths,st)
            # alg_11.Do()
            # alg_20 = ABC(self.adjacency,self.switches,src_0,dst_0,N[2],Max[0],K_paths,st)
            # alg_20.Do()
            alg_21 = ABC(self.adjacency,self.switches,src_0,dst_0,N[2],Max[1],K_paths,st)
            alg_21.Do()
