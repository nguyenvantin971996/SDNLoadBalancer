...
class MyTopo(Topo):	
	def build(self, **param):
		...
		self.addLink(s1, s3, 2, 1, bw=1000, delay='80ms', loss=0)
		self.addLink(s1, h1, 3, 1, bw=1000, delay='1ms', loss=0)
		self.addLink(s2, h2, 2, 1, bw=1000, delay='1ms', loss=0)
		self.addLink(s5, s2, 1, 3, bw=1000, delay='60ms', loss=0)
		self.addLink(s7, s5, 1, 2, bw=1000, delay='80ms', loss=0)
		self.addLink(s6, s7, 1, 2, bw=1000, delay='20ms', loss=0)
		self.addLink(s3, s6, 2, 2, bw=1000, delay='50ms', loss=0)
		self.addLink(s2, s4, 4, 1, bw=1000, delay='50ms', loss=0)
		self.addLink(s3, s4, 3, 2, bw=1000, delay='70ms', loss=0)
		self.addLink(s5, s4, 3, 3, bw=1000, delay='60ms', loss=0)
		self.addLink(s6, s4, 3, 4, bw=1000, delay='70ms', loss=0)
		self.addLink(h5, s5, 1, 4, bw=1000, delay='1ms', loss=0)
		self.addLink(h7, s7, 1, 3, bw=1000, delay='1ms', loss=0)
		self.addLink(h6, s6, 1, 4, bw=1000, delay='1ms', loss=0)
		self.addLink(h4, s4, 1, 5, bw=1000, delay='1ms', loss=0)
