...
from utils.action_noise import OUActionNoise, Add_Noise
...
class Agent(object):
    ...
    DDPG agent
    """
    def __init__(self, state_dims = [3], action_dims = [12], action_boundaries = [[0],[1]],
                actor_lr = 1e-5, critic_lr = 1e-4, batch_size = 1, gamma = 0.99,
        ...
        self._noise_2 = Add_Noise(mu=np.zeros(action_dims))
