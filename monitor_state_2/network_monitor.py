...
class NetworkMonitor(app_manager.RyuApp):
    ...
    def show_ult(self):
        ...
        spd = []
        self.state_r_t = {}
        self.state_r_t['state'] = []
        self.state_r_t['reward'] = 0
        ...
        if len(spd)!=0:
            ...
            if self.ult!=0:
                r = 1/self.ult - 5
                self.state_r_t['reward'] = round(r,3)
        term = False
        if self.ult < 0.001:
            term = True
        self.state_r_t['terminal'] = term
        self.state_r_t['state'] = spd
        print("Reward = ", r)