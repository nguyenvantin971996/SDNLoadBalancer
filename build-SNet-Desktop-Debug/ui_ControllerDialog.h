...
public:
    ...
    void setupUi(QDialog *ControllerDialog)
    {
        ...
        QObject::connect(buttonBox, SIGNAL(accepted()), ControllerDialog, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), ControllerDialog, SLOT(reject()));
    ...
    {
        ControllerDialog->setWindowTitle(QApplication::translate("ControllerDialog", "Dialog", nullptr));
        lblPort->setText(QApplication::translate("ControllerDialog", "Port", nullptr));
        lblIpAddress->setText(QApplication::translate("ControllerDialog", "IP Address", nullptr));
    } // retranslateUi
